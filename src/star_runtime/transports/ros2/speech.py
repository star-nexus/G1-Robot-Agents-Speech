...
This module intentionally has no top-level ROS imports. Importing ``star_runtime``
...
class Ros2EventSink(EventSink):
    ...
    def publish(self, event: SpeechEvent) -> PublishResult:
        if not self._started:
            return PublishResult(False, detail="ROS 2 event sink is not started")
        try:
            ...
            return PublishResult(False, detail=str(exc))
        self.published += 1
        ...
        *,
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "g1_speech_msgs package; build integrations/ros2 with colcon"
            ) from exc
