...
def ros_message_to_event(message: Any) -> SpeechEvent:
    """Convert the public ROS message into the transport-neutral contract."""
    return SpeechEvent(
        event_id=message.event_id,
        session_id=message.session_id,
        sequence=message.sequence,
        created_unix_ns=message.created_unix_ns,
...
class Ros2SpeechSubscriber:
    """Agent-side ROS 2 subscriber with an API matching the DDS subscriber."""
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise RuntimeError(
                "ROS 2 subscription requires a sourced ROS 2 environment and the "
    ...
    def start(self) -> None:
        ...
        self._executor_thread = threading.Thread(
            ...
            name="speech-agent-ros2-executor",
            daemon=True,
        )
        self._executor_thread.start()
        logger.info("ROS 2 SpeechEvent subscriber started")
    ...
    def _on_message(self, message: Any) -> None:
        self._callback(ros_message_to_event(message))
