# STAR Runtime ROS 2 Integration
...
PYTHONPATH="$PWD/src:$PYTHONPATH" python tests/acceptance/ros2_roundtrip.py
```
...
PYTHONPATH="$PWD/src:$PYTHONPATH" \
  .venv/bin/python tests/acceptance/ros2_lifecycle.py --config config.json

# GPU variant
PYTHONPATH="$PWD/src:$PYTHONPATH" \
  .venv-gpu/bin/python tests/acceptance/ros2_lifecycle.py --config config.gpu.json
```
